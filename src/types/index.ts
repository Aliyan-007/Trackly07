...
export interface ScheduleItem {id:string; title:string; day:number; start:string; end:string; kind:'class'|'study'|'event'; color:string; location?:string; date?:string}
